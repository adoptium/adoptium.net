...
vi.mock("next-intl", () => ({
  useTranslations: () => (key: string) => {
    ...
    if (key === "no-releases-found-description")
      return "Try adjusting your filters to find releases.";
    if (key === "checksum") return "Checksum";
    if (key === "this-build-is-jck-certified")
...
describe("ReleaseResults component", () => {
  ...
  it("should handle unknown OS with fallback icon", () => {
    const releases = [createMockRelease("unknown-os", "x64", "11.0.28+6")];
  ...
  it("should have proper CSS classes for styling", () => {
    ...
    expect(releaseCard).toHaveClass(
      "flex",
      "justify-between",
      "border",
      "rounded-[24px]"
