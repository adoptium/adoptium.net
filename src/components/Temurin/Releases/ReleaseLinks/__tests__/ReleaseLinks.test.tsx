...
const createMockRelease = (
    ...
    binary: {
            ...
            architecture: architecture as NonNullable<BinaryAssetView["binary"]>["architecture"],
            image_type: "jdk",
            package: {
                name: `${releaseName}.tar.gz`,
...
const createMockTemurinReleaseAssets = (
    ...
    sourceRelease?: BinaryAssetView,
): TemurinAssets => {
    const assets: TemurinAssets = [...releases]
    if (sourceRelease) {
        assets.source = sourceRelease
    }
    return assets
}
...
describe("ReleaseLinks component", () => {
    ...
    it("should handle TemurinAssets type correctly", () => {
        const mockReleases: TemurinAssets = createMockTemurinReleaseAssets(
