    ...
    <div ref={ref} className="flex flex-col items-center gap-6">
      {binary ? (
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-pink to-[#7026b9] rounded-full blur opacity-30 group-hover:opacity-60 transition duration-500 group-hover:duration-200"></div>
          <Link
            href={{
              pathname: "/download",
              query: {
            ...
            className="relative flex items-center justify-center gap-4 bg-purple text-white px-10 py-5 rounded-full ring-1 ring-white/20 hover:ring-pink/50 transition-all duration-300 hover:scale-[1.02]"
            onClick={() =>
              sendDownloadEvent({
                link: binary.link,
                os: userOSAPIName,
          ...
          >
            <span className="w-8 h-8 flex items-center justify-center text-pink">
              <OSIcon os={userOS} />
            </span>
      ...
      <Link
        ...
        className="text-sm text-gray-400 hover:text-pink transition-colors duration-300 flex items-center gap-2 group"
      >
        {t("other-downloads")}
        <span
