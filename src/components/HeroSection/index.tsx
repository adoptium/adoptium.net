...
const HeroSection = ({ latestLTS }: HeroSectionProps) => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-purple pt-20 pb-10"
    >
      {/* Background Gradient/Mesh */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-pink rounded-full blur-[120px] opacity-10 animate-pulse" />
