...
export type VendorName = (typeof vendors)[number]["name"];
            ...
            {randomizedVendors.map((vendor) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <FaCheck
                      className={`text-xs transition-opacity ${isSelected ? "opacity-100" : "opacity-0"}`}
                    />
                  </div>
                  ...
                  {/* Vendor Name */}
                  <div
                    className={`text-center text-sm font-medium truncate w-20 px-1 transition-colors duration-300
                                        ${
                                          isSelected
