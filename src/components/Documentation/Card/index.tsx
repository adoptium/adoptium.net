...
const DocumentationCard: React.FC<Props> = ({
  ...
  return (
    <div id={anchorId} className="w-full lg:w-1/3 p-3 group scroll-mt-25">
      <div className="relative bg-gradient-to-br from-[#200E46]/90 to-[#2B1A4F]/90 rounded-3xl border border-white/20 shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-[#FF1464]/10 hover:border-[#FF1464]/30 h-full transform hover:-translate-y-1">
          ...
          <div className="relative">
            <p className="mb-5 text-xl font-semibold flex items-center">
              ...
              <Link
                ...
                className="text-white/90 after:absolute after:inset-0 after:content-[''] after:z-0"
              >
                {title}
              </Link>
            </p>
