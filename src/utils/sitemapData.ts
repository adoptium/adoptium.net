...
export function generateSitemapData(): SitemapData {
  const sections: SitemapSection[] = [
    ...
    },
    {
      ...
      pages: [{ title: "Marketplace", url: "/marketplace" }],
    },
    {
      ...
      pages: [
        ...
        { title: "Migration Guide", url: "/temurin/migration" },
    ...
    },
    {
      ...
      pages: [
        ...
        {
          title: "Reproducible Verification Builds",
          url: "/docs/reproducible-verification-builds",
        },
      ],
    },
    {
