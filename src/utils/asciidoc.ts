...
/**
 * List of author usernames to exclude from documentation author lists.
 * Includes bot accounts and AI tools that should not be credited as human authors.
 */
...
/**
 * Returns true if the given author username should be excluded from author lists.
 */
  ...
  return {
    ...
    authors: doc.hasAttribute("page-authors")
      ? String(doc.getAttribute("page-authors"))
          ...
          .filter((author: string) => !isExcludedAuthor(author))
      : [],
