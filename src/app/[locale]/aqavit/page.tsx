...
import { FaRocket, FaBullseye, FaShieldAlt, FaCheckCircle, FaCode, FaChartLine, FaBolt, FaArrowRight } from "react-icons/fa"

export const metadata: Metadata = {
    title: "Eclipse AQAvit",
    description: "The Eclipse AQAvit project provides a set of tools and resources to help developers ensure the quality and performance of their Java applications.",
}

export default function AQAvitPage() {
    return (
        <div>
            {/* Hero Section */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="pt-24 pb-20 md:pt-32 md:pb-28 flex flex-col items-center">
                        <div className="absolute sm:static sm:z-auto top-[80px] z-[-1] left-[50%] translate-x-[-50%] sm:translate-x-0">
                            <Image
                                src="/images/backgrounds/aqavit-hero-bg.svg"
