          ...
          <>
            {link && (
              <>
                ...
                {vendor === "Adoptium" ? (
                  <>
                    You are downloading an Eclipse Temurin build, the
                    open-source community build from the Eclipse Adoptium
                    Working Group. If the download doesn&apos;t start in a few
                    seconds, please{" "}
                  ...
                  <>
                    You are downloading a build from{" "}
                    <strong>{capitalize(vendor)}</strong>, a member of the
                    Eclipse Adoptium Working Group. If the download doesn&apos;t
                    start in a few seconds, please{" "}
                    <span className="text-primary underline !underline-offset-[1px]">
                      <a href={link}>click here</a>
                    </span>{" "}
                    to start the download.
