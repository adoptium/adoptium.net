...
export const metadata: Metadata = {
  ...
  description:
    "The Eclipse Migration Toolkit for Java (EMT) is a set of tools designed to help developers and organizations migrate their Java applications to newer versions of the Java platform. It provides automated analysis, recommendations, and code transformation capabilities to simplify the migration process.",
};
          ...
          <div className="pt-24 pb-20 md:pt-32 md:pb-28 flex flex-col items-center">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="mt-8 text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed font-medium max-w-3xl mx-auto">
                A comprehensive tooling project for assisting Java version
                migration. EMT4J provides static and dynamic tools with detailed
                analysis reports to help migrate Java applications from previous
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <p className="text-gray-300 leading-relaxed">
                Java Agent, command-line tools, and Maven plugins provide
                flexible integration options for different development workflows
                and environments.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <p className="text-gray-300 leading-relaxed">
                Comprehensive analysis of potential incompatibility issues
                across Java versions, including JDK internal API usage and
                system changes.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <p className="text-gray-300 leading-relaxed">
                Generate detailed analysis reports in HTML, TXT, and JSON
                formats to integrate with your existing development and
          ...
          <div className="flex flex-col space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  The Eclipse Migration Toolkit for Java (EMT4J) is designed to
                  simplify the process of upgrading Java applications across
                  versions. Whether you&apos;re migrating from JDK 8 to 11 or
                  JDK 11 to 17, EMT4J provides the tools and insights you need.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed">
                  By analyzing your codebase statically and dynamically, EMT4J
                  identifies potential compatibility issues and provides
                  detailed reports with actionable recommendations to ensure a
              ...
              <div className="order-1 md:order-2 bg-gradient-to-br from-purple-600/40 to-pink-600/40 rounded-2xl p-6 shadow-xl backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/20 group">
                <div className="bg-white/15 backdrop-blur-md rounded-xl p-6 transform rotate-1 shadow-lg border border-white/10 group-hover:border-white/20 transition-all duration-300">
                  ...
                  <div className="text-gray-300">
                    An active project under the Adoptium umbrella, continuously
                    evolving to support the latest Java versions.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mt-24">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  EMT4J provides three different tools to fit your development
                  workflow:
                </p>
                <ul className="space-y-4 text-gray-300">
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong className="text-white">Java Agent:</strong>{" "}
                      Provides runtime context information and accurate call
                      stack analysis to find more potential issues
                    </div>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="text-green-400 mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Command-line Tool:</strong>{" "}
                      Easy to use without starting your application, though may
                  ...
                  <li className="flex items-start">
                    <FaCheckCircle className="text-green-400 mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Maven Plugin:</strong>{" "}
                      Integrates directly into your build process to catch
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mt-24">
              <div>
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  EMT4J supports analysis for the most common Java migration
                  scenarios, covering both JDK 8 to 11 and JDK 11 to 17 upgrade
                  paths.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Each migration path includes specific checks for known
                  compatibility issues, API changes, and system modifications
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-lg text-white/80">
                      Join developers worldwide who are using EMT4J to upgrade
                      their Java applications with confidence and minimal risk.
                    </p>
                  </div>
