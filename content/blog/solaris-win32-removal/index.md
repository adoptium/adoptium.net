...
Although Temurin has never had a significant user base on Solaris, we have been fortunate to have had [sponsorship](https://adoptium.net/sustainers) given to the project to cover the costs of the hardware for building, testing, and distributing on the two architectures for which Solaris is available. This sponsor no longer has a requirement for Temurin on Solaris and therefore we have taken the decision to stop shipping Solaris builds of Temurin in 2026. Without funding for the hardware and people stepping up to perform the work required for our test and release process it is not viable to continue to ship on Solaris platforms.
