...
- **Engineering Optimisation**: Sophia and Andrew Leonard implemented logic in the AQAvit test framework to rerun only failed arctic test cases rather than entire test targets. This work could then be leveraged by the Temurin Compliance project to significantly lower infrastructure use and compute costs and also reduce the time required to verify that Temurin builds are TCK compliant. Issue: [Extend the 'Rerun failed testcases' feature to arctic targets aqa-tests#6756](https://github.com/adoptium/aqa-tests/issues/6756), PRs: [Parsing regular expression for arctic TKG#779](https://github.com/adoptium/TKG/pull/779) and [Extended the rerun failed testcases feature to arctic aqa-tests#6757](https://github.com/adoptium/aqa-tests/pull/6757) and [Update Arctic runtests.sh to handle multiple ARCTIC_GROUPS for "custom" aqa-tests#6818](https://github.com/adoptium/aqa-tests/pull/6818)
