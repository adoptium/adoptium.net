...
You can download the logo in all available variants as PNG images with transparent background link:{baseurl}/docs/logo-styleguide/adoptium-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:{baseurl}/docs/logo-styleguide/temurin-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:{baseurl}/docs/logo-styleguide/aqavit-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:{baseurl}/docs/logo-styleguide/mission-control-logo.zip[here].

== Migration Toolkit by Adoptium

For the https://adoptium.net/en-GB/emt[Migration Toolkit project] we provide an official logo. The logo follows the same design language used across all Adoptium working group projects. Like other project logos, it can be used in both landscape and portrait modes:
...
You can download the logo in all available variants as PNG images with transparent background link:{baseurl}/docs/logo-styleguide/migration-toolkit-logo.zip[here].
