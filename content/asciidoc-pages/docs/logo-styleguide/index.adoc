...
You can download the logo in all available variants as PNG images with transparent background link:https://adoptium.net/docs/logo-styleguide/adoptium-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:https://adoptium.net/docs/logo-styleguide/temurin-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:https://adoptium.net/docs/logo-styleguide/aqavit-logo.zip[here].
...
You can download the logo in all available variants as PNG images with transparent background link:https://adoptium.net/docs/logo-styleguide/mission-control-logo.zip[here].
