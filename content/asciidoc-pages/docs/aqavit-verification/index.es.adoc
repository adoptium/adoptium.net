...
:page-description: Guía sobre cómo ejecutar las pruebas de verificación de AQAvit y recopilar resultados para la publicación.
:keywords: AQAvit, verificación, pruebas, java, calidad, adoptium, marketplace, qvsl
:lang: es
